export const VintageWrapper = ({ children }: { children: React.ReactNode }) => {
  return (
    <section className="relative min-h-[95vh] w-full flex flex-col justify-center bg-[#FDFCFB] dark:bg-[#050505f5] text-neutral-900 dark:text-[#EAE8E4]  overflow-hidden">
