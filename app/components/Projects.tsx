...
function ProjectRow({ project, index }: { project: Project; index: number }) {
  ...
  if (!mounted) return <div className="h-20" />; // Placeholder to prevent mismatch
    ...
    <Link href={project.liveUrl} target="_blank" rel="noopener noreferrer">
      ...
      >
        ...
        <div className="flex-1 lg:pr-12">
          <h3 className="text-4xl md:text-5xl lg:text-6xl font-serif tracking-tight mb-2 transition-transform duration-500 group-hover:translate-x-4">
            {project.title}
          </h3>
        ...
        <div className="flex-1 max-w-md mt-6 lg:mt-0">
          <p className="text-neutral-600 dark:text-neutral-400 mb-6 leading-relaxed hidden lg:block text-sm md:text-base">
            {project.description}
          </p>
        ...
        <div className="mt-8 lg:mt-0 lg:ml-12">
          ...
          >
            <span className="mr-2 transition-transform duration-300 group-hover/link:translate-x-1 italic font-serif normal-case text-lg tracking-normal">
              Explore
            </span>
            <span className="transition-opacity duration-300 group-hover/link:opacity-50">
              →
            </span>
          </a>
        </div>
